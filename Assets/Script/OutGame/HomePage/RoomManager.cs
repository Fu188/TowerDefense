...
public class RoomManager : MonoBehaviourPunCallbacks, IPunObservable
{
    ...
    private void ableJoinRoom(bool able)
    {
        if (PhotonNetwork.InRoom && PhotonNetwork.LocalPlayer.IsMasterClient)
        {
            PhotonNetwork.CurrentRoom.IsOpen = able;
            PhotonNetwork.CurrentRoom.IsVisible = able;
        }
    }
    private void Start()
    {
    ...
    public override void OnJoinedRoom()
    {
        ...
        // 这里可以调整
        textobj.GetComponentInChildren<Text>().text = "";*/
        Instantiate(textPrefab, layoutContent).GetComponentInChildren<Text>().text = "";
    }
