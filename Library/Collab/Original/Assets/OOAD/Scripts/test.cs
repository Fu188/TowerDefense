...
namespace ooad
{
    public class test : MonoBehaviourPunCallbacks
    {
        ...
        async void Start()
        {
            ...
            //;
            NetWorkInfo.host = "127.0.0.1";
            NetWorkInfo.RefreshBaseUrl(false);
            UserController uc = UserController.GetUserControllerInstance();
            uc.SignIn("test01@keykeeper.ga", "keykeeperT1pwd");
            uc.UpdateUserInfo(3);
